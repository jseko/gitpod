...
TARGET_DIR="${PROJECT_ROOT}/dev/preview/infrastructure/gce"
...
# Illustration purposes, but this will set the plan location to $TARGET_DIR/gce.plan if PLAN_LOCATION is not set
